...
const RouteRoleGuard: React.FC = () => {
  ...
  const rules: { pattern: RegExp; roles: Role[] }[] = [
    ...
    // Приложение
    { pattern: /^\/app\/chat$/, roles: ['ADMIN','TEACHER','STUDENT','PARENT'] },
    { pattern: /^\/app\/admin-chats$/, roles: ['ADMIN'] },
    { pattern: /^\/app\/ai-chat$/, roles: ['ADMIN','TEACHER','STUDENT'] },
    { pattern: /^\/app\/calendar$/, roles: ['ADMIN','TEACHER','STUDENT','PARENT'] },
    { pattern: /^\/app\/tasks$/, roles: ['ADMIN','TEACHER'] },
    { pattern: /^\/app\/neuro-abai$/, roles: ['ADMIN','TEACHER'] },
